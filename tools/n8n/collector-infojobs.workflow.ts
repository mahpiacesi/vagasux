...
function isRelevant(title) {
  ...
  const excluded =
    /\\b(vendedor|vendedora|auxiliar administrativo|apoio de loja|operador de loja|caixa|estoquista|consultor de vendas|sobrancelh|unha|barbeir|cabelo|estetic|manicure|pedicure|micropigment)\\b/.test(t);
  const designRole =
