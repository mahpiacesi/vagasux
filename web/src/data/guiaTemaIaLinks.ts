...
export const guiaTemaIaLinkSections: GuiaTemaLinkSection[] = [
  { title: 'IAs generativas', links: [
    { title: 'ChatGPT', description: 'Assistente para conversar, criar e analisar conteúdo.', url: 'https://chatgpt.com/pt-BR/' },
  ...
  { title: 'Criação de sites', links: [
    ...
    { title: 'Claude Code', description: 'Agente de código da Anthropic para o terminal.', url: 'https://claude.com/product/claude-code' },
    { title: 'v0', description: 'Gere interfaces web a partir de texto.', url: 'https://v0.app/' },
    { title: 'Lovable', description: 'Crie aplicações web conversando com IA.', url: 'https://lovable.dev/pt-br' },
  ...
  { title: 'Integração e automação de processos', links: [
    ...
    { title: 'Pipedream', description: 'Automação para integrar APIs e construir workflows.', url: 'https://pipedream.com/' },
  ] },
  { title: 'Criação de imagens e vídeos', links: [
    ...
    { title: 'Synthesia', description: 'Crie vídeos com avatares e narração por IA.', url: 'https://www.synthesia.io/pt-br' },
    { title: 'Bing Image Creator', description: 'Gere imagens com IA diretamente no Bing.', url: 'https://www.bing.com/images/create/ai-image-generator' },
    { title: 'Luma', description: 'Ferramentas de IA para imagens e vídeos.', url: 'https://lumalabs.ai/app' },
    { title: 'Lensa', description: 'Edição e criação de imagens com IA.', url: 'https://lensa.app/' },
    { title: 'Tome', description: 'Crie apresentações narrativas com IA.', url: 'https://tomeapp.ai/' },
  ] },
  { title: 'Recursos úteis', links: [
    { title: 'People + AI Guidebook', description: 'Boas práticas para construir produtos com IA.', url: 'https://pair.withgoogle.com/guidebook/' },
    { title: 'OpenUI', description: 'Toolkit open source para explorar componentes de interface.', url: 'https://www.openui.com/' },
