...
export const guiaGlossarioEntries: GuiaGlossarioEntry[] = [
  ...
  },
  {
    ...
    whatIs: [
      'Pessoa responsável por representar stakeholders, definir o que o produto precisa entregar e priorizar o backlog. Em times Scrum, garante que o squad entenda os itens no nível necessário para executar a sprint.',
  ...
  },
  {
    ...
    whatIs: [
      'Pessoa que facilita o processo ágil no squad: ajuda na priorização do backlog, monitora o andamento da sprint, conduz cerimônias e remove impedimentos do time.',
  ...
  {
    id: 'kpi', term: 'KPI', categoryId: 'produto', subgroup: 'conceitos',
    originalName: { alternate: 'Indicador-chave de desempenho' },
    whatIs: ['Métrica escolhida como sinal principal de desempenho para acompanhar um objetivo de negócio ou produto.', 'Ajuda o time a concentrar decisões nos indicadores mais relevantes, em vez de acompanhar números sem relação com a estratégia.'],
    youWillHear: ['"Qual KPI mostra se essa iniciativa deu certo?"', '"Esse KPI precisa melhorar no próximo trimestre."'],
  },
  {
    id: 'nps', term: 'NPS', categoryId: 'produto', subgroup: 'conceitos',
    originalName: { alternate: 'Net Promoter Score' },
    whatIs: ['Indicador de recomendação que pergunta a probabilidade de uma pessoa indicar um produto ou serviço.', 'Compara respostas promotoras e detratoras para acompanhar percepção e lealdade ao longo do tempo.'],
    youWillHear: ['"O NPS caiu depois da mudança no atendimento."', '"Vamos analisar os comentários dos detratores."'],
  },
  {
    id: 'csat', term: 'CSAT', categoryId: 'produto', subgroup: 'conceitos',
    originalName: { alternate: 'Customer Satisfaction Score' },
    whatIs: ['Mede satisfação com uma interação, funcionalidade ou atendimento específico.', 'Costuma ser aplicado logo após uma tarefa para entender se a experiência resolveu a necessidade da pessoa.'],
    youWillHear: ['"Vamos medir CSAT depois desse fluxo."', '"O CSAT do suporte melhorou este mês."'],
  },
  {
    id: 'ces', term: 'CES', categoryId: 'produto', subgroup: 'conceitos',
    originalName: { alternate: 'Customer Effort Score' },
    whatIs: ['Mede quanto esforço uma pessoa percebeu para completar uma tarefa ou resolver um problema.', 'É útil para avaliar fluxos de cadastro, suporte, pagamento e outras jornadas que devem ser simples.'],
    youWillHear: ['"Esse fluxo tem CES alto, precisamos reduzir etapas."', '"Vamos perguntar quanto esforço essa tarefa exigiu."'],
  },
  {
    id: 'conversion-rate', term: 'Conversion Rate', categoryId: 'produto', subgroup: 'conceitos',
    originalName: { alternate: 'Taxa de conversão' },
    whatIs: ['Percentual de pessoas que completam uma ação desejada, como cadastrar, comprar ou ativar uma funcionalidade.', 'Ajuda a localizar etapas de uma jornada que estão impedindo a pessoa de avançar.'],
    youWillHear: ['"A taxa de conversão do checkout caiu."', '"Vamos testar uma hipótese para aumentar a conversão."'],
  },
  {
    id: 'sus', term: 'SUS', categoryId: 'produto', subgroup: 'conceitos',
    originalName: { alternate: 'System Usability Scale' },
    whatIs: ['Questionário padronizado de dez perguntas para medir percepção de usabilidade de um sistema.', 'Gera uma pontuação comparável ao longo do tempo e funciona bem depois de testes ou avaliações de produto.'],
    youWillHear: ['"Vamos aplicar SUS após o teste de usabilidade."', '"A pontuação SUS indica que ainda há problemas de uso."'],
  },
  {
    id: 'bounce-rate', term: 'Bounce Rate', categoryId: 'produto', subgroup: 'conceitos',
    originalName: { alternate: 'Taxa de rejeição' },
    whatIs: ['Percentual de sessões que saem sem avançar para outra interação relevante no site ou produto.', 'Pode indicar expectativa desalinhada, conteúdo pouco claro, desempenho ruim ou uma jornada que não convida à continuidade.'],
    youWillHear: ['"A taxa de rejeição dessa landing page está alta."', '"Vamos revisar a proposta de valor e o carregamento da página."'],
  },
  {
    id: 'clv', term: 'CLV', categoryId: 'produto', subgroup: 'conceitos',
    originalName: { alternate: 'Customer Lifetime Value' },
    whatIs: ['Estimativa do valor que uma pessoa cliente gera durante toda a relação com uma empresa ou produto.', 'Ajuda a conectar decisões de experiência, retenção e receita no longo prazo.'],
    youWillHear: ['"Melhorar retenção aumenta o CLV."', '"Vamos comparar o custo de aquisição com o valor de vida do cliente."'],
  },
  {
    id: 'okr',
    term: 'OKR',
