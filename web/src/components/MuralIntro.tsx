  ...
  return (
    <section className="relative overflow-hidden px-5 pt-14 pb-10 md:px-6 md:pt-20 md:pb-12">
      ...
      <div className="mx-auto max-w-3xl md:max-w-5xl">
        <div className="flex flex-col items-center gap-10 md:flex-row md:items-center md:justify-between md:gap-10 lg:gap-14">
          ...
          <div className="mural-fade mural-fade-delay-1 w-full max-w-[22rem] shrink-0 md:max-w-[26rem] lg:max-w-[30rem]">
            <UmbrellaHeroIllustration className="umbrella-hero relative z-[2] h-auto w-full overflow-visible drop-shadow-[0_24px_48px_rgb(36_46_144_/_0.12)]" />
          </div>
        </div>
