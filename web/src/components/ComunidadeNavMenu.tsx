...
const itemClass =
  'block rounded-xl px-4 py-2.5 text-sm font-bold text-neutral-500 transition-colors hover:bg-brand-100/80 focus-visible:bg-brand-100/80 focus-visible:outline-none'
...
export function ComunidadeNavMenu({
  ...
  return (
    ...
    >
      <button
        type="button"
        className={`relative ${triggerClass} ${isComunidadeActive || open ? activeTriggerClass : ''}`}
        aria-haspopup="true"
        aria-expanded={open}
      >
        <Umbrella
