...
export function GuiaGlossarioEntryArticle({
  ...
  return (
    <article
      id={entry.id}
      className="scroll-mt-28 border-t border-neutral-500/10 pt-10 first:border-t-0 first:pt-0"
    >
      ...
      {entry.originalName ? (
        <div className="mt-4 rounded-2xl border border-brand-200/60 bg-brand-100/40 px-5 py-4">
