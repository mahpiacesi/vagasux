    ...
    <div className="mt-8 w-full">
      ...
      <section className="mt-10 rounded-3xl border border-brand-200/40 bg-brand-100/30 p-6 md:p-8">
        ...
        <form className="mt-7 grid gap-6" onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 sm:grid-cols-2"><label className="grid gap-2 text-sm font-bold text-neutral-500">Seu primeiro nome<input name="firstName" required maxLength={60} className="rounded-xl border border-neutral-500/15 px-3 py-2.5 font-normal" /></label><label className="grid gap-2 text-sm font-bold text-neutral-500">E-mail <span className="font-normal text-neutral-400">(privado)</span><input name="email" type="email" required className="rounded-xl border border-neutral-500/15 px-3 py-2.5 font-normal" /></label><label className="grid gap-2 text-sm font-bold text-neutral-500">LinkedIn <span className="font-normal text-neutral-400">(privado)</span><input name="linkedin" type="url" required className="rounded-xl border border-neutral-500/15 px-3 py-2.5 font-normal" /></label><label className="grid gap-2 text-sm font-bold text-neutral-500">Ano de término<input name="completedYear" type="number" min="1990" max="2100" required className="rounded-xl border border-neutral-500/15 px-3 py-2.5 font-normal" /></label></div>
