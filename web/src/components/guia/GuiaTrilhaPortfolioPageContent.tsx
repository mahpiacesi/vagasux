    ...
    <div className="mt-8 w-full pb-24">
      ...
      <header className="relative mt-8 overflow-hidden rounded-3xl bg-brand-100 px-6 py-8 md:px-10 md:py-10">
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="mt-4 max-w-xl text-base leading-relaxed text-neutral-400 md:text-lg">Um caminho para criar cases, praticar, publicar e revisar a sua apresentação profissional.</p>
