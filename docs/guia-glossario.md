...
**Uso no dia a dia:** Prompt, Engenharia de prompt, MD, Agente de IA, Skill, MCP
...
**IA:** 13 termos (ver subgrupos acima). LLM, prompt, MD, skill, MCP, agente de IA, alucinação e revisão humana.
